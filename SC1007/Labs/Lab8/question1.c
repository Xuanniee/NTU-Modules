...
{
    // Recursively using the Solution for the Sub-Problems by saving them and reusing them later
    // Base Case
    if (n == 0)
    {
        // A Global Int Ptr/Array is declared
        M[0] = 0;
        return 0;
    }
    else if (n == 1)
...
{
    // Start solving the sub-problems from n = 0 onwards until n
    M[0] = 0;
    M[1] = 1;
